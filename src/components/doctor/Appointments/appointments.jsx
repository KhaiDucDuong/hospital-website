        ...
        <div className="profile-info-widget">
          ...
          <div className="profile-det-info">
            ...
            <div className="patient-details">
              ...
              <h5>
                <i className="fas fa-map-marker-alt" /> California, United
                States
              </h5>
              <h5>
        ...
        <div className="profile-info-widget">
          ...
          <div className="profile-det-info">
            ...
            <div className="patient-details">
              ...
              <h5>
                <i className="fas fa-map-marker-alt" /> New Jersey, United
                States
              </h5>
              <h5>
        ...
        <div className="profile-info-widget">
          ...
          <div className="profile-det-info">
            ...
            <div className="patient-details">
              ...
              <h5>
                <i className="fas fa-envelope" /> walterroberson@example.com
              </h5>
              <h5 className="mb-0">
        ...
        <div className="profile-info-widget">
          ...
          <div className="profile-det-info">
            ...
            <div className="patient-details">
              ...
              <h5>
                <i className="fas fa-envelope" /> robertrhodes@example.com
              </h5>
              <h5 className="mb-0">
        ...
        <div className="profile-info-widget">
          ...
          <div className="profile-det-info">
            ...
            <div className="patient-details">
              ...
              <h5>
                <i className="fas fa-map-marker-alt" /> Colorado, United States
              </h5>
              <h5>
                <i className="fas fa-envelope" /> harrywilliams@example.com
              </h5>
              <h5 className="mb-0">
